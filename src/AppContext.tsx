...
const defaultInitialState: AppState = {
  ...
  error: undefined,
  activeTab: 'benvenuto',
  // FIX: Added missing properties to defaultInitialState
...
const appReducer = (state: AppState, action: AppAction): AppState => {
  switch (action.type) {
    ...
    // FIX: Add cases for normative data
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const performFundCalculation = useCallback(async () => {
    ...
    try {
      // FIX: Corrected function calls to match definitions by passing normativeData
